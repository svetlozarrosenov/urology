<?php
$title = esc_html( carbon_get_the_post_meta( 'crb_physician_locations_title' ) );
if ( empty( $title ) ) {
	return;
}
$locations_ids = crb_get_related_ids_from_association( 'crb_location_related_physicians' );
