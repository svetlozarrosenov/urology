<?php
$sidebar = [
	'image' => carbon_get_the_post_meta( 'crb_staff_sidebar_image' ),
	'btns' => carbon_get_the_post_meta( 'crb_staff_sidebar_btns' ),
	'specialities_title' => carbon_get_the_post_meta( 'crb_staff_sidebar_specialities_list_title' ),
	'certificates_title' => carbon_get_the_post_meta( 'crb_staff_sidebar_certificates_list_title' ),
];
